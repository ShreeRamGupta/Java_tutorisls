...
public class EmployeeDataGenerator {
    public static List<Employee> generateSampleData() {
        ...
        employeeList.add(new Employee("Ram disusa",80000.0,"IT",25,"Male",LocalDate.of(2025, 4, 15)));
        employeeList.add(new Employee("John Doe", 27000.0, "IT", 30, "Male", LocalDate.of(2019, 5, 15)));
        ...
        employeeList.add(new Employee("Ava Wilson", 29000.0, "HR", 24, "Female", LocalDate.of(2019, 10, 20)));
        ...
        employeeList.add(new Employee("Mathu Milders", 69000.0, "Engineering", 42, "Male", LocalDate.of(2017, 8, 14)));
        employeeList.add(new Employee("Miader Joson", 75000.0, "Admin", 34, "Female", LocalDate.of(2020, 3, 22)));
        employeeList.add(new Employee("Noahrat Mitolio", 67000.0, "Admin", 29, "Male", LocalDate.of(2017, 8, 14)));
        employeeList.add(new Employee("Mathu Modnisa", 89000.0, "Admin", 42, "Male", LocalDate.of(2017, 8, 14)));
